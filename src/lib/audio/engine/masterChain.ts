...
export function mapParamsToSettings(
  ...
  return {
    lowPassFrequency: lowPassFilterMapping.stepToValue(params.lowPass),
    highPassFrequency: highPassFilterMapping.stepToValue(params.highPass),
    phaserWet: phaserWetMapping.stepToValue(params.phaser),
    reverbWet: reverbWetMapping.stepToValue(params.reverb),
    reverbDecay: reverbDecayMapping.stepToValue(params.reverb),
    compThreshold: compThresholdMapping.stepToValue(params.compThreshold),
    compRatio: compRatioMapping.stepToValue(params.compRatio),
    compMix: compMixMapping.stepToValue(params.compMix),
    masterVolume: masterVolumeMapping.stepToValue(params.masterVolume),
  };
}
