...
export function interactableHighlight(isInteractable: boolean): string {
  return cn({
    "outline outline-2 outline-offset-1 outline-primary/40 focus-visible:outline focus-visible:outline-primary/50 focus-visible:outline-2 animate-outline-pulse":
      isInteractable,
  });
}
